#pragma checksum "C:\Users\basvm3\source\repos\CloudTransformer\OneCloudTransformer\Views\Pricing\ProductList.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "6bfb0e774ef9f0c610ba40cc249877b0c4042e3b"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"6bfb0e774ef9f0c610ba40cc249877b0c4042e3b", @"/Views/Pricing/ProductList.cshtml")]
    ...
    public class Views_Pricing_ProductList : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "6bfb0e774ef9f0c610ba40cc249877b0c4042e3b3719", async() => {
            }
            );
    ...
    jQuery(document).ready(function () {
        ...
        function fillProductList(result, source) {
            ...
            for (var i = 0; i < result.length; i++) {
                ...
                var prodDesc = product.description;  // 'Provision Windows and Linux virtual machi");
            WriteLiteral(@"nes in seconds';
                ...
                var itemDiv = ' <div class=""divProductItems""> ' +
                    ...
                    '  <");
            WriteLiteral(@"div class=""pricediv inline-flex margin-top30""> ' +
                    ...
                    '                 <span class=""priceText margin-left20"">$</span><span class=""  ' + priceValClass");
            WriteLiteral(@" + ' totalpriceVal  priceText margin-right20"">' + totalprodPrice + '</span>' +
                    '    </div>' +
                    '  </div>' +
                    ' </div> ';
        ...
        $("".clear-search"").click(function (e) {
            // Clear ");
            WriteLiteral(@"the ProductSearch textbox
            $("".product-search"").val('');
        ...
        $('.azureChkbox').change(function () {
            if (this.checked) {
                ...
                // CheckIf AWS checkbox is checked then di");
            WriteLiteral(@"splay that
        ...
        function createEstimateSummary() {
            ...
            $("".spinbutton"").each(function (e) {
                ...
                if (instanceCount > 0) {
                    ...
                    var prod");
            WriteLiteral(@"uctName = $(this).closest("".divProductItems"").find(""div.imageDescription"").html();
...
<div class="" divSelectSource inline-flex "" style=""margin-left:31%; border:1px solid blue; padding:20px; margin-bottom");
...
<div class=""divpagemaincontent inline-flex azureProductList"">
       ...
       ");
            ...
            <div class=""text-right"">
                <input type=""button"" id=""btnaddWorkItemIT"" class=""bluebutton addWorkItemIT"" value=""Create WorkItems"" />
            </div>
        </div>
</div>
...
<div class=""divpagemaincontent inline-flex awsProductList"">
    <div id=""divProductList"" class=""ProductList"">
        <div class=""product-search-container"">
            <input class=""product-search"" aria-label=""Search products"" placeholder=""Search products""");
            BeginWriteAttribute("value", " value=\"", 14543, "\"", 14551, 0);
            EndWriteAttribute();
            WriteLiteral(">\r\n            <button class=\"clear-search\" aria-label=\"Clear search\" type=\"submit\" data-bi-an=\"body\" data-bi-tn=\"clear-search\">×</button>\r\n        </div>\r\n        <div");
            BeginWriteAttribute("class", " class=\"", 14720, "\"", 14728, 0);
            EndWriteAttribute();
            WriteLiteral(@">
            <div class=""projectdivsection"">
                <div class=""row-header""> Product List: </div>
